...
class CardTests(unittest.TestCase):
    ...
    def test_repr(self):
        """repr should return a string in the format 'VALUE of SUIT'"""
...
class DeckTests(unittest.TestCase):
    ...
    def test_repr(self):
        """repr should return a string in the form 'Deck of 52 cards'"""
    ...
    def test_deal_sufficient_cards(self):
        """deal should deal the number of cards specified, if there are that many remaining"""
    ...
    def test_deal_no_cards(self):
        """deal should raise a ValueError if the deck is empty"""
